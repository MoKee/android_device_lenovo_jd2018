...
public class StowSensor implements ScreenStateNotifier, SensorEventListener {
    ...
    public StowSensor(MoKeeActionsSettings mokeeActionsSettings, SensorHelper sensorHelper,
                SensorAction action) {
    ...
    public void screenTurnedOff() {
        if (!mMoKeeActionsSettings.isIrWakeupEnabled() &&
            mMoKeeActionsSettings.isPickUpEnabled() && !mEnabled) {
            Log.d(TAG, "Enabling");
