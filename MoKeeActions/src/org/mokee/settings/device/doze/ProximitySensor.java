...
public class ProximitySensor implements ScreenStateNotifier, SensorEventListener {
    private static final String TAG = "MoKeeActions-ProximitySensor";
    ...
    public ProximitySensor(MoKeeActionsSettings mokeeActionsSettings, SensorHelper sensorHelper,
                SensorAction action) {
