...
public class LiftToSilence extends PhoneStateListener implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "MoKeeActions-LiftToSilence";
    ...
    public LiftToSilence(MoKeeActionsSettings mokeeActionsSettings, Context context,
    ...
    public void updateState() {
        if (mMoKeeActionsSettings.isLiftToSilenceEnabled()) {
